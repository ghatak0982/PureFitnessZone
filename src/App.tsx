    ...
    <div className="min-h-screen bg-black text-white font-inter">
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 border-2 border-white flex items-center justify-center">
              <span className="font-anton text-2xl">PFZ</span>
            </div>
            <span className="font-anton text-xl tracking-wider">PURE FITNESS ZONE</span>
          </div>
      ...
      <section id="home" className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none">
          ...
          <p className="text-white text-sm md:text-lg font-inter tracking-widest uppercase mt-6 drop-shadow-lg max-w-2xl text-center px-4">
      ...
      <section id="services" className="py-0">
        <div className="hidden md:grid md:grid-cols-3">
          ...
          <div className="action-tile h-[70vh] relative cursor-pointer" data-testid="progression-tile">
            ...
            />
            <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-8">
        ...
        <div className="md:hidden overflow-x-auto snap-x snap-mandatory">
          <div className="flex">
            {/* Progression Tile */}
            <div className="action-tile h-[55vh] min-w-[90vw] relative cursor-pointer snap-center" data-testid="progression-tile-mobile">
              <img 
                src="https://images.unsplash.com/photo-1603077492340-e6e62b2a688b?w=800&h=1200&fit=crop&auto=format&q=80"
                alt="Progression tracking"
                className="absolute inset-0 w-full h-full object-cover grayscale"
              ...
              <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-6">
                ...
                <h3 className="font-anton text-2xl mb-2 tracking-wider">PROGRESSION</h3>
                <p className="text-xs leading-relaxed">
                  Track your journey with data-driven insights.
                </p>
              </div>
            </div>

            {/* Workout Tile */}
            <div className="action-tile h-[55vh] min-w-[90vw] relative cursor-pointer snap-center" data-testid="workout-tile-mobile">
              <img 
                src="https://images.unsplash.com/photo-1653773869760-5b0f846231fb?w=800&h=1200&fit=crop&auto=format&q=80"
                alt="Intense workout"
                className="absolute inset-0 w-full h-full object-cover grayscale"
              ...
              <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-6">
                ...
                <h3 className="font-anton text-2xl mb-2 tracking-wider">WORKOUT</h3>
                <p className="text-xs leading-relaxed">
                  Structured training for maximum results.
                </p>
              </div>
            </div>

            {/* Nutrition Tile */}
            <div className="action-tile h-[55vh] min-w-[90vw] relative cursor-pointer snap-center" data-testid="nutrition-tile-mobile">
              <img 
                src="https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=800&h=1200&fit=crop&auto=format&q=80"
                alt="Nutrition and wellness"
                className="absolute inset-0 w-full h-full object-cover grayscale"
              ...
              <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-6">
                ...
                <h3 className="font-anton text-2xl mb-2 tracking-wider">NUTRITION</h3>
                <p className="text-xs leading-relaxed">
                  Science-backed nutrition guidance for your goals.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="border-2 border-black p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold">098934 76857</p>
                  </div>
                </div>
              </div>
            ...
            <div className="h-[500px] border-2 border-black overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3667.577132532499!2d77.41436727570576!3d23.185628910222892!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c430cbe75ec47%3A0x7c62a1675caa20b7!2sPure%20Fitness%20Zone!5e0!3m2!1sen!2sin!4v1766821505628!5m2!1sen!2sin"
                width="100%"
                height="100%"
        ...
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-10 h-10 border-2 border-white flex items-center justify-center">
              <span className="font-anton text-xl">PFZ</span>
            </div>
            <span className="font-anton text-2xl tracking-wider">PURE FITNESS ZONE</span>
          </div>
          <p className="text-gray-400 mb-2">Kolar Road, Bhopal</p>
          <p className="text-gray-600 text-sm">Your Fitness Destination</p>
          <p className="text-gray-700 text-xs mt-4">© {new Date().getFullYear()} Pure Fitness Zone. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
